...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData() {
        new WeatherTask().execute(SunshinePreferences.getPreferredWeatherLocation(this));
    }
    ...
    class WeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... strings) {
            ...
            try {
                ...
                return OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(getBaseContext(), result);
            } catch (IOException e) {
                e.printStackTrace();
