...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNetworkProgressBar = (ProgressBar) findViewById(R.id.pb_network);
    ...
    private void toggleDataView(boolean isOn) {
        mWeatherTextView.setVisibility(isOn ? View.VISIBLE : View.INVISIBLE);
        mErrorTextView.setVisibility(isOn ? View.INVISIBLE : View.VISIBLE);
    }
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPostExecute(String[] weatherData) {
            ...
            toggleDataView(weatherData != null);
        }
    }
